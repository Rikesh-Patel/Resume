...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Rikesh's Portfolio</title>
    ...
    <header class="s-header">
        ...
        <nav class="header-nav-wrap">
            <ul class="header-nav">
                ...
                <li><a class="smoothscroll"  href="#blog" title="blog">Projects</a></li>
...
<img id="target" src="images/2.jpg" class="img-bg"/>
        ...
        <div class="home-content">
            ...
            <mark.dark> <div class="row home-content__main">
    ...
    <section id="about" class="s-about target-section">
        ...
        <div class="row narrow section-intro has-bottom-sep">
            <div class="col-full text-center">
                ...
                <h1>More About Me</h1>
                <p class="lead">
                    An Economics degree candidate with minor in
data science, I strive to generate reports that make data exciting, draw insights from trends, and confidently tackle emerging questions. I hope to create a mutually beneficial relationship with my employer to sustain a win-win dynamic and break expectations
                </p>
            </div>
        </div>
        ...
        <div class="row about-content">
            ...
            <div class="col-six tab-full left">
                ...
                <p>Francis Bacon once said,  "Knowledge is power." Now, centuries later, data is power. To reach this stage, I apply myself. From the first moments with my computer, I have always had a fondness for number games. These games with rows and rows of digits itched the quantitative side of my brain, and to this day I could still enumerate the classics. Of course, all the numbers in the game were relevant. Analysis. Essentially to win the game, I needed to make the numbers greater, so I did. Everything from Google sheets to Excel, from putting a weight on my mouse to Python-scripting and macros; if it made me more money, saved time, or got an achievement in the game, I would do it. The peak of this fascination was clicking ‘start’ and then lying back in my chair as some authority took hold of my screen in a predetermined manner. 
                </p> <p>
                    Without knowing it, this past time would lead me up the path of data modeling. This is my grand scheme-to generate these efficiencies, lionize strengths, snip weaknesses for the most elaborate game of them all. To me, Data is a whole new world where potential is limitless. Imagine the possibilities. I love creating, editing videos, writing story lines, and designing graphics. Hence, with my foundation in econometrics and working experience with  data visualization, I yearn to achieve great strides.
         ...
         <div style="width: 100%; display: table;">
            <div style="display: table-row">
                <div class="row about-content about-content--timeline">
                    ...
                    <div class="col-six tab-full left div-bg">
                        <div class="timeline">
        
                            <div class="timeline__block">
                                <div class="timeline__bullet"></div>
                                <div class="timeline__header">
                                    <p class="timeline__timeframe">Sep 2020 - June 2023</p>
                                    <h3>University of California, Los Angeles</h3> <img src="https://brand.ucla.edu/images/logos-and-marks/campus-logo.jpg" style="min-width: 20%;max-width: 20%;flex-basis: 70%">
                                    <h5>Bachelor's Economics and minor in Data Science</h5>
                                </div>
                                <div class="timeline__desc">
                                    <p> &#8226;Advanced Econometrics
                                        <br> &#8226; Financial modeling
                                        <br> &#8226; Intermediate Financial Accounting
                                        <br> &#8226; Game Theory</p>
                                </div>
                            </div>
        ...
        <div class="row about-content about-content--buttons">
            ...
            <div class="col-six tab-full left">
                <a href="#0" class="btn btn--primary full-width"href="path_to_file" download="Resume">Download My Resume</a>
            </div>
            ...
            <div class="col-six tab-full left">
                <div class="timeline">
                    ...
                    <div class="timeline__block">
                        ...
                        <div class="timeline__desc">
                            <p> &#8226; Created vendor quoting platform to extract, model, and predict market price conditions
                                <br> &#8226; Developed Power app to consolidate everyday field tasks
                                <br> &#8226; Create dynamic dashboards to track progress, deadlines, and cost impacts
                                <br> &#8226; Concur with others to streamline logistics with business systems, such as sales, order management, accounting, etc.
                                <br> &#8226; Collect, organize, and integrate processed data</p>
                        </div>
    ...
    <section id="blog" class="s-blog target-section">
        ...
        <div class="row narrow section-intro has-bottom-sep">
            <div class="col-full">
                ...
                <p class="lead"> As someone who wishes to continue to grow, I will showcase my personal projects here for any beneficiary. </p>
            </div>
        </div>
    ...
    <section id="contact" class="s-contact target-section">
        ...
        <div class="row narrow section-intro">
            <div class="col-full">
                ...
                <p class="lead">To reach me, please leave me a message here.</p>
            </div>
        </div>
        ...
        <div class="row contact__main">
            <div class="col-eight tab-full contact__form">
                ...
                <div class="message-success">
                    Your message was sent. Thank you and have a good day!<br>
                </div>
                        
            </div>
            <div class="col-four tab-full contact__infos">
<!--                <h4 class="h06">Phone</h4>
                <p>Mobile: (+1) 310 739 0526<br>
                </p>

                <h4 class="h06">Email</h4>
                <p>rikeshpatel@g.ucla.edu
                </p>-->
    ...
    <footer>
        <div class="row">
            <div class="col-full">
                ...
                <ul class="footer-social">
                    <li><a href="https://www.linkedin.com/in/rikesh-patel-738898236/">
        ...
        <div class="row footer-bottom">
            ...
            <div class="col-twelve">
                ...
                <div class="go-top">
                <a class="smoothscroll" title="Back to Top" href="#home"><i class="im im-arrow-up" aria-hidden="true"></i></a>
                </div>
            </div>
